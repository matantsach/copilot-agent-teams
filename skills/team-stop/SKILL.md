...
5. Clean up worktrees:
   - Run `bash <path-to-cleanup> <team_id>` to remove teammate worktrees,
     where `<path-to-cleanup>` is the absolute path to [cleanup-worktrees.sh](../../scripts/cleanup-worktrees.sh)
