...
5. Spawn teammates:
   - Try tmux: `bash <path-to-spawn-teammate> <team_id> <agent_id> "<task_description>" [model]`
     where `<path-to-spawn-teammate>` is the absolute path to [spawn-teammate.sh](../../scripts/spawn-teammate.sh)
